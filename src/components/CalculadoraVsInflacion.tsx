    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <div className="card text-center">
          <p className="text-[13px] uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Interés en 30 días</p>
          <p className="mt-1 font-bold text-green-700 dark:text-green-300">+{formatARS2(r.interes30)}</p>
        </div>
        <div className="card text-center">
          <p className="text-[13px] uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Pérdida por inflación</p>
          <p className="mt-1 font-bold text-red-700 dark:text-red-300">−{formatARS2(r.perdidaInflacion30)}</p>
        </div>
        <div className="card text-center">
          <p className="text-[13px] uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Balance real del mes</p>
